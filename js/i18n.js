...
window.BSI18n = (function () {
  ...
  var dict = {
    ru: {
      ...
      deckPromo: 'Создайте свою презентацию за 2 минуты — ПРОФБРОКЕР, удобные инструменты в одном месте',
    ...
    en: {
      ...
      deckPromo: 'Create your own presentation in 2 minutes — PROFBROKER, handy tools in one place',
