...
window.BSI18n = (function () {
  ...
  var dict = {
    ru: {
      ...
      secLocationHint: 'Необязательно. Адрес и координаты — по ним построим карту на слайде локации; если координаты не указаны, слайд локации в презентации не появится',
      fLocationNameLabel: 'Локация',
      fLocationNamePh: 'напр. Хоста, Сочи, Краснодарский край',
      fCoordsPasteLabel: 'Координаты или ссылка из Яндекс.Карт',
      fCoordsPastePh: 'напр. 43.5397321, 39.8944543',
      fCoordsPasteHint: 'В Яндекс.Картах: щёлкните правой кнопкой по нужной точке на карте → «Что здесь» → скопируйте появившиеся координаты и вставьте сюда. С телефона: откройте точку в приложении → «Поделиться» → скопируйте ссылку и вставьте её сюда',
      coordsOk: '✓ Координаты определены: {lat}, {lng}',
      coordsResolving: 'Открываем ссылку…',
      coordsFail: 'Не удалось найти координаты — скопируйте их из карты (цифры вида 43.5397, 39.8944) и вставьте сюда',
      fCoordsPasteLabelGoogle: 'Координаты или ссылка из Google Карт',
      fCoordsPasteHintGoogle: 'В Google Картах: щёлкните правой кнопкой по нужной точке на карте → нажмите на появившиеся координаты (они скопируются) и вставьте сюда. С телефона: откройте точку в приложении → «Поделиться» → скопируйте ссылку и вставьте её сюда',
      fCountryLabel: 'Страна объекта',
      countryRussia: 'Россия', countryThailand: 'Таиланд', countryUae: 'ОАЭ', countryTurkey: 'Турция',
      countryCyprus: 'Кипр', countryMontenegro: 'Черногория', countrySpain: 'Испания', countryGeorgia: 'Грузия',
      countryIndonesia: 'Индонезия (Бали)', countryVietnam: 'Вьетнам', countryOther: 'Другая страна',
      ...
      fCamFeeLabel: 'Эксплуатационные платежи (в месяц)',
      ...
      fCompanyNamePh: 'напр. Аврора Недвижимость',
      ...
      fAgentNamePh: 'напр. Анна Иванова',
      ...
      fDataConsentLabelPrefix: 'Я даю ',
      fDataConsentLink: 'согласие на обработку своих персональных данных',
      ...
      footerPromoPrefix: 'Создайте свою первую презентацию за 2 минуты — ',
      footerPromoLink: 'здесь',
      footerBrandTagline: '— ваши удобные инструменты в одном месте',
      footerBotPrefix: 'Ваш удобный помощник: ',
      deckPromo: 'Создайте свою презентацию за 2 минуты — ПРОФФБРОКЕР, удобные инструменты в одном месте',
      ...
      deckCreateOwnBtn: 'Создать свою презентацию',
      ...
      myListingsTitle: 'Мои презентации',
      myListingsOpen: 'Открыть →',
      myListingsUntitled: 'Без названия',
      myListingsNote: 'Список хранится на этом устройстве и в этом браузере. Всё, что вы создаёте, сохраняется автоматически — сюда можно вернуться в любой момент.',
      ...
      pdfSavedCopyLink: 'Отправить клиенту',
      ...
      saveStatusSaving: 'Сохраняем изменения… не закрывайте страницу',
      saveStatusSaved: '✓ Изменения сохранены',
      saveStatusError: 'Не удалось сохранить изменения',
      saveStatusRetry: 'Повторить',
      consentRenewNote: 'Вы изменили контактные данные — подтвердите согласие заново',
      clientShareMessage: 'Ссылка на презентацию для клиента — клиент откроет её без регистрации. Отправьте в мессенджер или скопируйте:',
      clientShareText: 'Презентация объекта «{title}»:',
      ...
      slotCover: 'Обложка — главный вид объекта снаружи',
      ...
      slotFinal: 'Финальный кадр — вечерний вид объекта',
      ...
      policySec2P1: 'Оператором персональных данных является: ПРОФБРОКЕР (Быстросайт.РУ) (далее — «Оператор»).',
    ...
    en: {
      ...
      secLocationHint: 'Optional. Address and coordinates — used to build the map on the location slide; if coordinates are missing, the location slide won\'t appear in the presentation',
      fLocationNameLabel: 'Location',
      fLocationNamePh: 'e.g. Khosta, Sochi, Krasnodar Krai',
      fCoordsPasteLabel: 'Coordinates or a link from Yandex Maps',
      fCoordsPastePh: 'e.g. 43.5397321, 39.8944543',
      fCoordsPasteHint: 'In Yandex Maps: right-click the point on the map → "What\'s here" → copy the coordinates that appear and paste them here. On a phone: open the point in the app → Share → copy the link and paste it here',
      coordsOk: '✓ Coordinates found: {lat}, {lng}',
      coordsResolving: 'Opening the link…',
      coordsFail: 'Could not find coordinates — copy them from the map (numbers like 43.5397, 39.8944) and paste them here',
      fCoordsPasteLabelGoogle: 'Coordinates or a link from Google Maps',
      fCoordsPasteHintGoogle: 'In Google Maps: right-click the point on the map → click the coordinates that appear (they get copied) and paste them here. On a phone: open the point in the app → Share → copy the link and paste it here',
      fCountryLabel: 'Property country',
      countryRussia: 'Russia', countryThailand: 'Thailand', countryUae: 'UAE', countryTurkey: 'Turkey',
      countryCyprus: 'Cyprus', countryMontenegro: 'Montenegro', countrySpain: 'Spain', countryGeorgia: 'Georgia',
      countryIndonesia: 'Indonesia (Bali)', countryVietnam: 'Vietnam', countryOther: 'Other country',
      ...
      fNearbyPh: 'Beach — 7 min\nSochi city center — 15 min\nInternational school — 12 min\nSupermarket — 5 min\nYoga studio — 3 min\nSochi Airport (Adler) — 30 min',
      ...
      fCamFeeLabel: 'Service fee (per month)',
      ...
      fCompanyNamePh: 'e.g. Aurora Realty',
      logoNoLogo: 'No logo',
      ...
      fDataConsentLabelPrefix: 'I give my ',
      fDataConsentLink: 'consent to the processing of my personal data',
      ...
      footerPromoPrefix: 'Create your first presentation in 2 minutes — ',
      footerPromoLink: 'here',
      footerBrandTagline: '— your handy tools in one place',
      footerBotPrefix: 'Your handy assistant: ',
      deckPromo: 'Create your own presentation in 2 minutes — PROFFBROKER, handy tools in one place',
      ...
      deckCreateOwnBtn: 'Create your own presentation',
      ...
      myListingsTitle: 'My presentations',
      myListingsOpen: 'Open →',
      myListingsUntitled: 'Untitled',
      myListingsNote: 'This list is stored on this device, in this browser. Everything you create is saved automatically — you can come back here any time.',
      ...
      pdfSavedCopyLink: 'Send to client',
      ...
      saveStatusSaving: 'Saving changes… keep this page open',
      saveStatusSaved: '✓ Changes saved',
      saveStatusError: 'Could not save changes',
      saveStatusRetry: 'Retry',
      consentRenewNote: 'You changed your contact details — please confirm your consent again',
      clientShareMessage: 'Presentation link for your client — they open it without signing up. Send it via a messenger or copy it:',
      clientShareText: 'Property presentation "{title}":',
      ...
      slotCover: 'Cover — the property’s main exterior view',
      ...
      slotFinal: 'Final shot — evening view of the property',
