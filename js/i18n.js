...
window.BSI18n = (function () {
  ...
  var dict = {
    ru: {
      ...
      fCoordsPasteLabelGoogle: 'Вставить координаты из Google Карт',
      fCoordsPasteHintGoogle: 'В Google Картах: щёлкните правой кнопкой по нужной точке на карте → нажмите на появившиеся координаты (они скопируются) и вставьте сюда, поля ниже заполнятся сами. Ссылку из Google Карт тоже можно вставить',
    ...
    en: {
      ...
      fCoordsPasteLabelGoogle: 'Paste coordinates from Google Maps',
      fCoordsPasteHintGoogle: 'In Google Maps: right-click the point on the map → click the coordinates that appear (they get copied) and paste them here, the fields below fill in automatically. A Google Maps link works too',
